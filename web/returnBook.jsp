      ...
      <div class="row">
          ...
          <div class="col-md-10">
              <div class="jumbotron" style="background-color: rgba(229,229,229,0.3); box-shadow: 1px 1px 20px rgba(0,0,0,0.2);margin-left: 2%;">
                  <center><h3 style="margin-top: -1%;"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Return Book </h3></center>
                      ...
                      <div class="container">
                          <div class="row">
                              <div class="col-md-8 col-md-offset-2" style="background-color: white; padding: 50px; border-radius: 10px; box-shadow: 2px 2px 10px #737373;">
                                  <form action="return_book" method="POST" id="sellForm">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <select class="form-control" name="books" onchange="fetch_select(this.value);">
                                        ...
                                        <!-- Retrieving values from Database. -->
                                            <% 
                                                  ...
                                                  try
                                                  {
                                                      ...
                                                      String query1 = "SELECT * FROM ROOT.\"Transact\" WHERE USERNAME='"+str+"' AND STATUS='A'";
                                        ...
                                        <%
                                            ...
                                            <center><input type="submit" class="btn btn-default" value="Return Book"></center>
                                    </form>
                              </div>
                          </div>
                      </div>
          ...
          <div class="col-md-2">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li role="presentation"  class="active"><a href="returnBook.jsp"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> &nbsp;Return Book</a></li>
              </ul>
          </div>
      </div>
