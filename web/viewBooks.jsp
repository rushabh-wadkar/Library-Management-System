                                        ...
                                        <%
                                            ...
                                            try
                                            {
                                                ...
                                                while(rs.next())
                                                {
                                                    %>
                                                    <tr>
                                                        <td><center><a data-toggle="tooltip" data-placement="bottom" title="Click here more details" href="search.jsp?bookname=<%= rs.getString("bookname") %>"><%= rs.getInt("sr") %></a></center></td>
                                  <td><center><a data-toggle="tooltip" data-placement="bottom" title="Click here more details" href="search.jsp?bookname=<%= rs.getString("bookname") %>"><%= rs.getString("bookname") %></a></center></td>
                                  <td><center><a data-toggle="tooltip" data-placement="bottom" title="Click here more details" href="search.jsp?bookname=<%= rs.getString("bookname") %>"><%= rs.getString("authorname") %></a></center></td>
                                  <td><center><a data-toggle="tooltip" data-placement="bottom" title="Click here more details" href="search.jsp?bookname=<%= rs.getString("bookname") %>"><%= rs.getString("publishername") %></a></center></td>
                                  <td><center><a data-toggle="tooltip" data-placement="bottom" title="Click here more details" href="search.jsp?bookname=<%= rs.getString("bookname") %>"><%= rs.getInt("quantity") %></a></center></td>
                                  <td><center><a data-toggle="tooltip" data-placement="bottom" title="Click here more details" href="search.jsp?bookname=<%= rs.getString("bookname") %>"><%= rs.getInt("noofpages") %></a></center></td>
                                  <td><center><a data-toggle="tooltip" data-placement="bottom" title="Click here more details" href="search.jsp?bookname=<%= rs.getString("bookname") %>"><%= rs.getInt("nooflikes") %></a></center></td>
                                  <td><center><a data-toggle="tooltip" data-placement="bottom" title="Click here more details" href="search.jsp?bookname=<%= rs.getString("bookname") %>"><%= rs.getInt("noofdislikes") %></a></center></td>
                                  <td><center><a data-toggle="tooltip" data-placement="bottom" title="Click here more details" href="search.jsp?bookname=<%= rs.getString("bookname") %>"><%= rs.getString("timeday") %></a></center></td>
                                    </tr>
                                                    <%
                                                }
                                            }
              ...
              <ul class="nav nav-pills nav-stacked">
                ...
                <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="active"><a href="viewBooks.jsp"> <span class="glyphicon glyphicon glyphicon-eye-open" aria-hidden="true"></span> View Books</a></li>
                    </ul>
                </li>
              </ul>
          </div>
