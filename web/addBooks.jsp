...
<html lang="en">
  ...
  <body style="font-family: OpenSans;">
      ...
      <div class="row">
          ...
          <div class="col-md-10">
              <div class="jumbotron" style="background-color: rgba(229,229,229,0.3); box-shadow: 1px 1px 20px rgba(0,0,0,0.2);margin-left: 2%;">
                  <center><h3 style="margin-top: -1%;"><span class="glyphicon glyphicon-cloud-upload" aria-hidden="true"></span> Add Books</h3></center>
                              ...
                              <div class="col-md-8 col-md-offset-2" style="background-color: white; padding: 50px; border-radius: 10px; box-shadow: 2px 2px 10px #737373;">
                                  <form action="add" method="POST">
                                    <div class="form-group">
                                      ...
                                      <input type="text" tabindex="1" class="form-control" required id="bookName" autocomplete="off" name="bookName" placeholder="Enter Book Name">
                                      <center><span id="output" style="font-style: italic; "></span></center>
                                    </div>
                                      
                                    <div class="form-group">
                                      <label for="authorName">Author Name</label>
                                      <input type="text" tabindex="2" class="form-control" required  id="authorName" autocomplete="off" name="authorName" placeholder="Enter Author Name">
                                    </div>
                                      
                                    <div class="form-group">
                                      <label for="publisherName">Publisher Name</label>
                                      <input type="text" tabindex="3" class="form-control" required  id="publisherName" autocomplete="off" name="publisherName" placeholder="Enter Publisher Name">
                                    </div>
                                      
                                    <div class="form-group">
                                      <label for="noOfPages">No of Pages</label>
                                      <input type="text" tabindex="4" class="form-control" required  id="noOfPages" autocomplete="off" name="noOfPages" placeholder="Enter the Number of Pages">
                                    </div>
                                      
                                    <div class="form-group">
                                      <label for="price">Price</label>
                                      <input type="text" tabindex="5" class="form-control" required  id="price" autocomplete="off" name="price" placeholder="Enter the Price per book">
                                    </div>
                                      
                                    <div class="form-group">
                                      <label for="quantity">Quantity</label>
                                      <input type="text" tabindex="6" class="form-control" required  id="quantity" autocomplete="off" name="quantity" placeholder="Enter the Quantity">
                                    </div>
                                      
                                      <center><input type="submit" class="btn btn-default" value="Add Book"></center>
                                  </form>
                              </div>
                          </div>
                      </div>
              ...
              <ul class="nav nav-pills nav-stacked">
                ...
                <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                      <li class="active"><a href="addBooks.jsp"> <span class="glyphicon glyphicon glyphicon-pencil" aria-hidden="true"></span> Add Books</a></li>
        ...
        <%
            if(request.getAttribute("status")!=null)
            {
                ...
                if(status.equalsIgnoreCase("success"))
                {
                    %>
                        $(function(){
                                var textie = " book added successfully";
                                var bookie = "<%= BookName %>".concat(textie);
    ...
    <!-- Script to check the bookname already exists or not -->
    <script>
        
        $(document).ready(function(){
            $('#bookName').on('input',function()
            {
              var bookName = $(this).val().toUpperCase();
